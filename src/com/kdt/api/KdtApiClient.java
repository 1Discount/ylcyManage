...
public class KdtApiClient {
    ...
    /**
     * 有赞(旧名口袋通)的API信息从: https://koudaitong.com/v2/apps/open/setting 获取
     *
     */
	/** 店铺: 途狗全球漫游WIFI */
	...
	/** 店铺: 途狗测试店铺 */
//	private static final String APP_ID = "2b261b89f52a67aa6b";
//	private static final String APP_SECRET = "515ab338e7bcfdedb50b3a44b31d5504";

    private String appId;
    private String appSecret;

    public KdtApiClient() throws Exception{
        if ("".equals(APP_ID) || "".equals(APP_SECRET)){
