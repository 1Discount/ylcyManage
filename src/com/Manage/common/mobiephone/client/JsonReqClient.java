 ...
 * @project rest_demo
 */
package com.Manage.common.mobiephone.client;
...
import com.Manage.common.mobiephone.model.AppBill;
import com.Manage.common.mobiephone.model.Callback;
import com.Manage.common.mobiephone.model.ClientBill;
import com.Manage.common.mobiephone.model.TemplateSMS;
import com.Manage.common.mobiephone.model.VoiceCode;
...
public class JsonReqClient extends AbsRestClient {
	...
	/**
	 * @param accountSid d7d114bd922e6d5e4e291f1a29a3cbfe
	 * @param authToken  1231ddab9efa242f45cbae5f8a905c90
	 * @param appId f8644583bf7049dd9aa6aa469c38c58d
	 * @param clientName 客户名称
	 * @param clientType 0
	 * @param charge 0
	 * @param mobile 自定义电话号码
	 *
	 */
	@Override
	public String createClient(String accountSid,String authToken, String appId,String clientName,String clientType,String charge,String mobile) {
		// TODO Auto-generated method stub
		String result = "";
		DefaultHttpClient httpclient=getDefaultHttpClient();
