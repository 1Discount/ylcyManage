...
@Repository
public class DistributorMenuGroupInfoDao extends BaseDao<DistributorMenuGroupInfoDao> {
	private static final String NAMESPACE = DistributorMenuGroupInfoDao.class.getName() + ".";
	/**
	 * 添加角色组信息.
	 * @param menuGroupInfo
	 * @return
