...
@Repository
public class DistributorRoleToMenuDao extends BaseDao<DistributorRoleToMenuDao> {
	private static final String NAMESPACE = DistributorRoleToMenuDao.class.getName() + ".";
	/**
	 * 批量添加角色菜单映射信息.
	 * @param 
	 * @return
