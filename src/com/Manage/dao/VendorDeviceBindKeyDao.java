...
@Repository
public class VendorDeviceBindKeyDao extends BaseDao {

	private static final String NAMESPACE = VendorDeviceBindKeyDao.class.getName() + ".";
	...
	public String getPage(SearchDTO searchDTO) {
		try {
			...
			List<VendorDeviceBindKey> arr = (List<VendorDeviceBindKey>) page.getRows();
			JSONObject object = new JSONObject();
			object.put("success", true);
			object.put("totalRows", page.getTotal());
			object.put("curPage", page.getCurrentPage());
			JSONArray ja = new JSONArray();
			for (VendorDeviceBindKey a : arr) {
...
//			return object.toString();
	...
	{
		try {
			return (VendorDeviceBindKey)getSqlSession().selectOne(NAMESPACE + "queryById", id);
		} catch (Exception e) {
			e.printStackTrace();
			throw new BmException(Constants.common_errors_1004, e);
		}
	 ...
	 * @return
	 */
	public int insertInfo(VendorDeviceBindKey info) {
		try {
	 ...
	 * @return
	 */
	public int updateInfo(VendorDeviceBindKey info) {
		try {
	 ...
	 * @return
	 */
	public int updateInfoSysStatus(VendorDeviceBindKey info) {
		try {
	 ...
	 * @return
	 */
	public int updateInfoStatus(VendorDeviceBindKey info) {
		try {
