...
public class Mail {
	...
	public static void main(String[] args) {
		...
		String from = "hg_lipeng@126.com";// 邮件显示名称
		String to = "2864193637@qq.com";// 收件人的邮件地址，必须是真实地址
		String copyto = "";// 抄送人邮件地址
		String subject = "【订单提醒】您有新订单请注意查看！";// 邮件标题
		String content = "luo ri de 你好！";// 邮件内容
		String username = "hg_lipeng@126.com";// 发件人真实的账户名
