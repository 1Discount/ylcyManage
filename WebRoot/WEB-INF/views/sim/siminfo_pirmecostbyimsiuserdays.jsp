...
<body>
        ...
        <SECTION id="main-content">
            <SECTION class="wrapper" style="">
                <DIV class="col-md-12">
                           ...
                           <FORM class="form-inline " id="leibie" method="get" action="#">
                               ...
                               <div class="form-group">
                                  ...
                                  <div class="form-group ">
                                    ...
                                    <input type="text" id="IMSI" name="IMSI" value="${IMSI }" class="form_datetime form-control"/>
                               </div>
                   ...
                   <DIV class="panel">
                     <DIV class="panel-heading">使用天数详情</DIV>
                     <DIV class="panel-body">
                         <DIV class="table-responsive">
                             <TABLE id="searchTable">
                                 <TR>
                                     ...
                                     <TH w_render="userDays" width="5%"><b>使用天数</b></TH>
                                     ...
                                     <TH w_index="totalPrice" width="10%"><b>价格</b></TH>
    ...
    <script type="text/javascript">
	    ...
	    $(function(){
	       gridObj = $.fn.bsgrid.init('searchTable',{
	           url:'<%=basePath%>sim/siminfo/getSIMRecordPageByIMSI',
	...
	<%--  function userDays(record, rowIndex, colIndex, options){
		return '<A  href="<%=basePath%>sim/siminfo/">'+record.userDays+'</A>';
	 } --%>
    </script>
