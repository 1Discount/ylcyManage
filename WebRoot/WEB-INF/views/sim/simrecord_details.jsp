...
<body>
        ...
        <SECTION id="main-content">
            <SECTION class="wrapper" style="">
                <DIV class="col-md-12">
                       ...
                       <DIV class="panel-body">
                           <FORM class="form-inline" id="searchForm" method="get" action="#">
                               <div class="form-group">
                                    ...
                                    <input type="text" id="creatorDate" name="creatorDate" value="${creatorDate}" data-popover-offset="0,8" class="form_datetime form-control"/>
                               </div>
                               <div class="form-group">
                                 ...
                                 <select name="country" id="country" class="form-control">
                                   ...
                                   <c:forEach items="${Countries}" var="country" varStatus="status">
                                       <option value="${country.countryCode}" <c:if test="${country.selected==true}">selected="selected"</c:if>>${country.countryName}</option>
                                   </c:forEach>
                                 </select>
                               </div>
                               <div class="form-group">
                                    <LABEL class="inline-label">IMSI：</LABEL>
                                    <input type="text" id="IMSI" name="IMSI" data-popover-offset="0,8" class="form-control"/>
                               </div>
                               <div class="form-group">
                                    <LABEL class="inline-label">SIM卡代号：</LABEL>
                                    <input type="text" id="code" name="code" data-popover-offset="0,8" class="form-control"/>
                               </div>
                               <DIV class="form-group">
                   ...
                   <DIV class="panel">
                     <DIV class="panel-heading">SIM卡使用详情</DIV>
                     <DIV class="panel-body">
    ...
    $(function(){
        ...
        gridObj = $.fn.bsgrid.init('searchTable',{
            url:'<%=basePath%>sim/siminfo/getSIMRecordCountByCountry',
