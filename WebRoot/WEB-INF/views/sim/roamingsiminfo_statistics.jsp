...
<html>
  <head>
    <title>SIM卡状态统计-漫游卡管理-EASY2GO ADMIN</title>
    <meta charset="utf-8">
    ...
    <section id="container">
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"><h3 class="panel-title">全部漫游SIM卡状态统计</h3></div>
...
<%--		            <th w_index="alert" width="10%;">充值预警卡数</th>--%>
		            <th w_index="status_available" width="10%;">正常卡数</th>
		            <th w_index="status_using" width="10%;">欠费中卡数</th>
		            <th w_index="status_unavailable" width="10%;">损坏或丢失卡数</th>
	            </table>
	            </div>
            </div>
          </div>
                        ...
                        <div class="tab-content tasi-tab">
                            <div id="country" class="tab-pane active">
                                <div class="row">
                                    <div class="col-md-12">
            <div class="panel">
            <div class="panel-heading"><h3 class="panel-title">漫游SIM卡状态 - 全部国家 </h3></div>
            <div class="panel-body">
...
<%--	            <th w_render="render_alertSimsCount">充值预警卡数</th>--%>
	            <th w_index="avalableSimsCount">正常卡数</th>
	            <th w_index="usingSimsCount">欠费卡数</th>
	            <th w_index="unavalableSimsCount">损坏或丢失数</th>
	            <th w_render="render_cardStatus_avalableSimsCountPercent">正常卡百分比</th>
	            <th w_render="render_cardStatus_usingSimsCountPercent">欠费卡百分比</th>
	            <th w_render="render_cardStatus_unavalableSimsCountPercent">损坏或丢失卡百分比</th></tr>
	        </table></div>
            </div>
            </div>
            <div id="special-note-country">备注：<br><br>
<p>1. 按“国家和地区”统计系按“可用国家”来统计的，所以若某张卡在多个国家或地区可用，则在各个国家或地区均会被统计，这样，这列的统计数字相加，并不一定与上面的“SIM卡总数”一致。其他全部列类似！ 按“运营商查”看则不会这样。</p>
            </div>
                                    </div>
                                </div>
                            </div>
                            <div id="operator" class="tab-pane ">
                                <div class="row">
                                    <div class="col-md-12">
            <div class="panel">
            <div class="panel-heading"><h3 class="panel-title">漫游SIM卡状态 - 全部运营商</h3></div>
            <div class="panel-body">
...
<p>1. 目前，按“运营商”查看未显示那些未指定运营商/运营商字段空白的记录。</p>
    ...
    $(function(){
    	gridObjAllCount = $.fn.bsgrid.init('searchTableSTotalCount',{
            url:'<%=basePath %>sim/roamingsiminfo/statistics/count',
            // autoLoad: false,
            pageAll:true,
        });
    });
    ...
    var gridObjStatusByCountry;
     $(function(){
             gridObjStatusByCountry = $.fn.bsgrid.init('searchTableStatusByCountry',{
                 url:'<%=basePath %>sim/roamingsiminfo/statistics/getpagebycountry',
                 // autoLoad: false,
                 pageAll:true,
             });
         });
    ...
    var hasByOperatorLoaded = false;
     $(function(){
             gridObjStatusByOperator = $.fn.bsgrid.init('searchTableStatusByOperator',{
                 url:'<%=basePath %>sim/roamingsiminfo/statistics/getpagebyoperator',
