...
<html>
  <head>
    <title>编辑服务器-SIM服务器管理-EASY2GO ADMIN</title>
    <meta charset="utf-8">
...
<!--       </div> -->
      <div class="panel">
        <div class="panel-heading">
          <h4 class="form-title">更新SIM服务器</h4>
        </div>
        <div class="panel-body">
          ...
          autocomplete="off" class="form-horizontal">
            ...
            <input type="hidden" name="SIMServerID" value="${Model.SIMServerID}">
            <div class="form-group">
              <label for="sim_server_code" class="col-md-3 control-label">编号:</label>
              <div class="col-md-6">
                <input id="sim_server_code" type="text" name="serverCode" value="${Model.serverCode}" data-popover-offset="0,8"
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="sim_server_ip" type="text" name="IP" value="${Model.IP}" data-popover-offset="0,8"
                required class="form-control">
              </div>
              <div class="col-sm-3">
                <p class="form-control-static"><span class="red">* </span>
    ...
    <c:forEach items="${ServerStatusDict}" var="item" varStatus="status">
                                   <c:if test="${Model.serverStatus eq item.label}">
                                      <option value="${item.label}" selected="selected">${item.label}</option>
                                    </c:if>
                                    <c:if test="${Model.serverStatus ne item.label}">
