        ...
        <SECTION id="main-content">
            <SECTION class="wrapper" style="">
                <DIV class="col-md-12">
                       ...
                       <DIV class="panel-body">
                           <FORM class="form-inline" id="leibie" method="get" action="#">
                               ...
                               <div class="form-group">
                                ...
                                <label class="checkbox-items"><INPUT class="" name="isMoreCountry" value="1" type="checkbox" >只查看多国</label>
                               ...
                               <DIV class="form-group">
                                ...
                                <div class="form-group">
                                    <LABEL class="inline-label">国家：</LABEL>
                                    <input type="text" id="IMSI" name="IMSI" value="${IMSI }" class="form-control"/>
                               </div>
                                <div class="form-group">
                                    <LABEL class="inline-label">国家：</LABEL>
                                    <input type="text" id="begindate" name="begindate" value="${begindate }" class="form-control"/>
                               </div>
                               <div class="form-group">
                                    <LABEL class="inline-label">国家：</LABEL>
                   ...
                   <DIV class="panel">
                     <DIV class="panel-heading">使用详情</DIV>
                     <DIV class="panel-body">
                         <DIV class="table-responsive">
                             <TABLE id="searchTable">
                                 <TR>
                                       ...
                                       <TH w_index="creatorDate" width="17%"><b>使用日期</b></TH>
                                       <TH w_index="country" width="17%"><b>已使用国家</b></TH>
                                       <TH w_index="useFlow" width="17%"><b>使用流量（KB）</b></TH>
                                     <!--  <TH w_index="countryList" width="17%"><b>可使用国家</b></TH> -->
    ...
    <script type="text/javascript">
	    ...
	    $(function(){
	       gridObj = $.fn.bsgrid.init('searchTable',{
	           url:'<%=basePath%>sim/siminfo/getPageSIMcostStatisticsByDay',
	   ...
	   /*  function imsi(record, rowIndex, colIndex, options){
	    	if(record.countryList.indexOf(",")>0){
	    		return '<A style="color:#1FB5AD;" href="http://e.easy2go.cn:80/sim/siminfo/tosiminfo_pirmecostinfobyimsi' + record.SIMID + '">'+record.IMSI+'</A>';
