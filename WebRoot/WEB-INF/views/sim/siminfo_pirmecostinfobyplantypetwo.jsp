                       ...
                       <DIV class="panel-body ">
                           <FORM class="form-inline " id="leibie" method="get" action="#">
                               ...
                               <div class="form-group hidden">
                                    ...
                                    <input type="text" id="planType" name="planTypePar"  value="${planType}" class="form-control"/>
                               </div>
                     ...
                     <DIV class="panel-body">
                         <DIV class="table-responsive">
                             <TABLE id="searchTable">
                                 <TR>
                                     <TH w_render="IMSI" width="8%"><b>IMSI</b></TH>
                                     <TH w_index="simAlias" width="4%"><b>卡代号</b></TH>
                                     ...
                                     <TH w_index="primeCost" width="4%"><b>成本(元)</b></TH>
    ...
    <script type="text/javascript">
	    ...
	    $(function(){
	       gridObj = $.fn.bsgrid.init('searchTable',{
	           url:'<%=basePath%>sim/siminfo/getpagesimbyplanType',
	 ...
	 function IMSI(record, rowIndex, colIndex, options){
		return '<A  href="<%=basePath%>sim/siminfo/tosiminfo_pirmecostbyimsiuserdays?IMSI='+record.IMSI+'&'+$('#leibie').serialize()+'">'+record.IMSI+'</A>';
	 }
