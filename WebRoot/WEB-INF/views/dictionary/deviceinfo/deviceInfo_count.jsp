...
<html>
  <head>
    <title>设备统计-统计报表-EASY2GO ADMIN</title>
    <meta charset="utf-8">
...
<FORM class="form-inline" id="searchTimeCounts" role="form" method="get" action="">
...
<DIV class="form-group">
<BUTTON class="btn btn-primary" type="button" onclick="gridObj.options.otherParames =$('#searchTimeCounts').serializeArray();gridObj.refreshPage();">搜索</BUTTON>
...
<H3 class="panel-title">所有设备</H3></DIV>
<DIV class="panel-body">

<table id="searchTable" class="table table-bordered table-hover" style="text-align:center;">
        <tr>
            <th w_index="allDevice" width="10%;" style="text-align:center;">全部设备数</th>
            <th w_index="kyDevice" width="10%;"style="text-align:center;">可用设备数</th>
            <th w_index="chDevice" width="10%;"style="text-align:center;">出货设备数</th>


            <th w_index="wxDevice" width="10%;"style="text-align:center;">维修设备数</th>
            <th w_index="deleDevice" width="10%;"style="text-align:center;">已删除设备数 </th>
        </tr>
</table>
    ...
    bootbox.setDefaults("locale","zh_CN");
          ...
          $(function(){
             gridObj = $.fn.bsgrid.init('searchTable',{
                 url:'<%=basePath %>device/deviceSearchend',
                 pageAll:true
             });
