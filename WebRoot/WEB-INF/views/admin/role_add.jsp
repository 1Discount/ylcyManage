...
<html>
<head>
<title>添加角色-权限管理-EASY2GO ADMIN</title>
<meta charset="utf-8">
					...
					<DIV class="panel">
						...
						<DIV class="panel-body">
							<FORM id="role_form" class="form-horizontal" role="form" method="post" action="">
								<INPUT name="_csrf" value="K63s7Htl-lOgiwhUulfchx1Wh9eqZ44Mg5ME" type="hidden">
								<DIV class="form-group">
									<LABEL class="col-md-2 control-label">名称:</LABEL>
									<DIV class="col-md-6">
										<INPUT id="role_name" class="form-control" name="roleName" type="text" required="" data-popover-offset="0,8">
									</DIV>
									<DIV class="col-md-4">
								...
								<DIV class="form-group">
									...
									<DIV class="col-md-6">
										<INPUT id="role_remark" class="form-control" name="remark" type="text" data-popover-offset="0,8">
									</DIV>
									<DIV class="col-md-4">
										<P class="form-control-static"></P>
									</DIV>
								...
								<DIV class="form-group">
									<LABEL class="col-md-2 control-label" for="permission_group_no">权限:</LABEL>
									<DIV class="col-md-10">
										<DIV class="checkbox">
											<c:forEach items="${mglist}" var="mg" varStatus="status">

												<DIV class="checkbox-group">
													<STRONG>${mg.menuGroupName}</STRONG>
												</DIV>
												<c:forEach items="${mg.menuInfos}" var="m" varStatus="status">
													<LABEL class="checkbox-items">
														<INPUT name="role_menu" value="${m.menuInfoID}" type="checkbox">
														${m.menuName}
													</LABEL>
												</c:forEach>
											</c:forEach>
...
$(function(){
	...
	$("#role_form").submit(function(){
		...
		$.ajax({
			type:"POST",
			url:"<%=basePath%>admin/roleinfo/rolemenuadd",
				dataType : "html",
				data : {
				menulist : chk_value.toString(),
