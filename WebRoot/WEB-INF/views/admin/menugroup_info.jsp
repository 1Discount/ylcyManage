...
<html>
  <head>
    <title>添加菜单组-权限管理-EASY2GO ADMIN</title>
    <meta charset="utf-8">
...
<table id="searchTable">
    ...
    $(function(){
       ...
       gridObj = $.fn.bsgrid.init('searchTable',{
           url:'<%=basePath %>admin/menuGroupinfo/getpage',
           // autoLoad: false,
           pageSizeSelect: true,
           pageSize: 10,
   ...
   function addsub(){
	   ...
	   var urlpath="<%=basePath %>admin/menuGroupinfo/insertinfo";
	   if($("#menuGroup_ID").val()!=null && $("#menuGroup_ID").val()!=''){
		   urlpath="<%=basePath %>admin/menuGroupinfo/editinfo";
	   }
	   $.ajax({
			type:"POST",
			url:urlpath,
   ...
   function deleteinfo(index){
	   ...
	   $.ajax({
			type:"POST",
			url:"<%=basePath %>admin/menuGroupinfo/deleteinfo",
			dataType:"html",
