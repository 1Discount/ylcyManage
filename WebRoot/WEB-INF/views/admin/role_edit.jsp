...
<UL class="nav nav-pills nav-stacked" role="tablist">
  ...
  href="<%=basePath %>admin/roleinfo/rolelist">全部角色</A></LI>
  <LI role="presentation"><A 
href="<%=basePath %>admin/roleinfo/add">添加角色</A></LI></UL></DIV></DIV></DIV>
<DIV class="col-md-9">
<DIV class="panel">
...
$(function(){
	...
	$("#role_form").submit(function(){
		...
		$.ajax({
			type:"POST",
			url:"<%=basePath %>admin/roleinfo/editsave",
			dataType:"html",
			...
			success:function(data){
				...
				data=parseInt(data);
				if(data==1){
					window.location="<%=basePath %>admin/roleinfo/rolelist";
				}else if(data==0){
