...
<html>
  <head>
    <title>添加权限菜单-权限管理-流量运营中心</title>
    <meta charset="utf-8">
...
<table id="searchTable">
    ...
    $(function(){
       gridObj = $.fn.bsgrid.init('searchTable',{
           url:'<%=basePath %>admin/menuinfo/getpage',
           // autoLoad: false,
           pageSizeSelect: true,
           pageSize: 30,
   ...
   function addsub(){
	   ...
	   var urlpath="<%=basePath %>admin/menuinfo/insertinfo";
	   
	   if($("#menu_ID").val()!=null && $("#menu_ID").val()!=''){
		   urlpath="<%=basePath %>admin/menuinfo/editinfo";
	   }
   ...
   function deleteinfo(index){
	   ...
	   $.ajax({
			type:"POST",
			url:"<%=basePath %>admin/menuinfo/deleteinfo",
			dataType:"html",
