...
<html>
  <head>
    <title>TDM列表-TDM管理-EASY2GO ADMIN</title>
    <meta charset="utf-8">
...
<table id="searchTable">
    ...
    function operate(record, rowIndex, colIndex, options) {
        return '<A class="btn btn-primary btn-xs" href="<%=basePath%>tdm/toEdit?TDMId='+record.TDMId+'"><SPAN class="glyphicon glyphicon-edit">编辑</SPAN></A>&nbsp;&nbsp;&nbsp;&nbsp;<A class="btn btn-primary btn-xs" onclick="deleteinfo('+rowIndex+')" href="#"><SPAN class="glyphicon glyphicon-remove">删除</SPAN></A>';
    }
    //删除.
    function deleteinfo(index){
        if(confirm("确认删除此这个TDM吗?")) {
 	   var record= gridObj.getRecord(index);
 	   $.ajax({
 			type:"POST",
 			url:"<%=basePath %>tdm/deletebyid",
 			dataType:"html",
 			data:{TDMId:record.TDMId,sysStatus:0},
