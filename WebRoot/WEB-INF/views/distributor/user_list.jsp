...
<html>
  <head>
    <title>所有用户-用户管理-EASY2GO ADMIN</title>
    <meta charset="utf-8">
    ...
    bootbox.setDefaults("locale","zh_CN");
          ...
          $(function(){
             gridObj = $.fn.bsgrid.init('searchTable',{
                 url:'<%=basePath %>distributor/adminuserinfo/datapage',
                 // autoLoad: false,
                 pageSizeSelect: true,
                 pageSize: 10,
      ...
      <%-- <A class="btn btn-primary btn-xs"   href="<%=basePath %>admin/adminuserinfo/touseredit?userID='+record.userID+'&userName='+record.userName+'&phone='+record.phone+'"><SPAN class="glyphicon glyphicon-edit">编辑</SPAN></A>&nbsp;&nbsp;&nbsp;&nbsp; --%>
         ...
         function deletebyid(userID){
        	 bootbox.confirm("确定删除吗?", function(result) {
        		 if(result){
        			 $.ajax({
                		 type:"POST",
                		 url:"<%=basePath %>distributor/adminuserinfo/datetebyid",
                		 data:{userID:userID},
                		 dataType:'html',
         ...
         function usertorole(index){
        	 ...
        	 window.location="<%=basePath %>distributor/adminuserinfo/usertorole?userID="+record.userID+"&userName="+record.userName+"&email="+record.email;
         }
