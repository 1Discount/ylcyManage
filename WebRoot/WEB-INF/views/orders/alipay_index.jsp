...
.new-btn-login{
    ...
    background-image: url("http://183.16.199.87:8090/ylcyManage/static/images/new-btn-fixed.png");
    border: medium none;
}
.new-btn-login{
...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action="<%=basePath %>refund/alipayapi" method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
					<dt>卖家支付宝帐户：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDseller_email" value="cseasy2go@163.com" />
						<span>必填</span>
					</dd>
					<dt>退款当天日期：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDrefund_date" value="2015-11-06 09:30:56"/>
					...
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDdetail_data" value="2015110621001004530060137230^0.01^xieshangtuikuan"/>
