							...
							<FORM class="form-inline" id="searchForm" role="form" method="get" action="#">
								<div class="form-group">
									...
									<select name="distributorName" class="form-control" id="distributorName">
										<c:forEach items="${enterprises}" var="item" varStatus="status">
											<option value="${item.enterpriseID}">${item.enterpriseName}</option>
										</c:forEach>
									</select>
								</div>
								<DIV class="form-group">
    ...
    bootbox.setDefaults("locale","zh_CN");
          ...
          $(function(){
             ...
             gridObj = $.fn.bsgrid.init('searchTable',{
                url:'<%=basePath%>orders/flowdealorders/getpageenterprise?isUserd=是',
                pageSizeSelect: true,
				autoLoad : true,
				pageSize : 15,
             ...
             gridObj1 = $.fn.bsgrid.init('searchTable1',{
                url:'<%=basePath%>orders/flowdealorders/getpageenterprise?isUserd=否',
				autoLoad : true,
				pageSizeSelect: true,
				pageSize : 15,
				otherParames : $('#searchForm').serializeArray(),
	   ...
	   function orderidOP(record, rowIndex, colIndex, options) {
        ...
        function excelExport(){
        	...
        	var endDate=$("#order_creatorDateend").val();
         	...
         	var url =  '<%=basePath%>orders/flowdealorders/enterpriseflowexportexeclTwoUserd?distributorName=' + distributorName+'&SN='+SN+'&begindateForQuery='+beginDateForQuery+'&enddate='+endDate+'&isUserd=是';
