							...
							<DIV class="table-responsive">
								<TABLE id="searchTable2">
									<TR>
										...
										<TH w_index="firmWareVer"  width="10%"><b>漫游软件版本</b></TH>
										<TH w_index="firmWareAPKVer"  width="10%"><b>漫游APK版本</b></TH>
										<TH w_index="version"  width="10%"><b>本地软件版本</b></TH>
										<TH w_index="versionAPK"  width="10%"><b>本地APK版本</b></TH>
