...
<html>
  <head>
    <title>批量导入设备-设备管理-流量运营中心</title>
    <meta charset="utf-8">
...
<p>4. "无效数据"指缺少了必要的"设备机身码"列值. 还要注意"序号"列必须正确提供, 否则该记录会被完全忽略</p>
<p>5. "插入失败"的原因可能有: 与数据库原记录重复(如设备机身码), 数据库内部出错等</p>
<p>6. 上面出错的记录都已列举出其序号, 请保存好此日志信息, 及时处理后再尝试导入</p>
<p>7. 如果对已存在的设备进行导入 ，会覆盖掉之前的数据，例如:excel中填写机身码和设备颜色，只会根据机身码来修改设备颜色其他字段不变</p>
